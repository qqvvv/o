 ...
 */
export function create(imageUrls, options = {}) {
  // 参数提取
    const {
      genSeq = false,
      sequential = false,
  ...
  imageUrls.forEach((url, idx) => {
    ...
    seqLabel.textContent = `${idx + 1}`;
    seqLabel.dataset.index = idx;
    ...
    imgWrapper.appendChild(seqLabel);
